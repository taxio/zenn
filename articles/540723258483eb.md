...
### 所感
* RIP-7560 では ERC-4337 をベースに非常にシンプルに Account Abstraction を Core に実装している
* UserOperation が TransactionType4 に変わっただけで、Account Contract, Paymaster がやることも変わら無い
* EntryPoint に対して Gas 代を deposit していたが、Core 実装のおかげでそこの実装がいらなくなった
* Core 側が Contract の interface を強制しているのは面白い
