...
TODO: https://github.com/ethereum/RIPs/pull/3#discussion_r1421828225
...
### 所感
RIP-7560 では ERC-4337 をベースにシンプルに Account Abstraction を Core に実装しています。
...
また、ERC-4337 にも存在した署名集約に関してもスコープに入れているようで、まだ RIP には反映していないが盛り込んでいく予定だそうです。
そうなると Validation Tx の構造がまた変わりそうですね。[^aggregate-validation]

[^aggregate-validation]: https://github.com/ethereum/RIPs/pull/3#discussion_r1407717422
